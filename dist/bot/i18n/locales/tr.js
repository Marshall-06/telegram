...
const messages = {
    ...
    importantNotes: "*Onemli Bilgiler*\n\n" +
    ...
    depositCreated: "*Yatirim Talimati*\n\nTutar: {amount} {currency}\nAg: {network}\nAna Trust Wallet:\n`{masterWallet}`\n\nReferans (memo):\n`{reference}`\n\n_Gonderim sonrasi yatiriminiz onaylanacaktir._",
    depositNoMasterWallet: "Ana Trust Wallet henuz tanimlanmadi.\nYonetici ile iletisime gecin.",
    withdrawWalletPrompt: "Trust Wallet adresinizi girin ({network}, ornek: 0x...):",
    withdrawAmountPrompt: "Cekmek istediginiz {currency} tutarini girin (minimum {min}).\n\nCekim gunleri: {withdrawDays}",
    withdrawCreated: "*Cekim Talebi Alindi*\n\nTutar: {amount} {currency}\nDurum: Onay bekliyor\nPlanlanan gun: {scheduledFor}\n\n_Gonderim sonrasi bakiyeniz guncellenecektir._",
    ...
    invalidWallet: "Gecersiz Trust Wallet adresi.\nOrnek: 0x ile baslayan 42 karakter ({network})",
    ...
    adminWithdrawCompleted: "Cekim tamamlandi.\nID: {id}\nKullanici: {user}\nTutar: {amount} {currency}\nBakiye dusuldu.",
    adminWithdrawCancelled: "Cekim iptal edildi.\nID: {id}\nKullanici: {user}\nTutar: {amount} {currency}",
    ...
    languagePrompt: "Lutfen dil secin:\n\n🇹🇷 Turkce\n🇬🇧 English\n🇷🇺 Russkiy",
